...
function serializeFloat(outputValue) {
  ...
  if (!(0, _isFinite.default)(num) && coercedValue !== 'null') {
...
function coerceFloat(inputValue) {
  if (!(0, _isFinite.default)(inputValue) && inputValue !== 'null') {
...
var GraphQLFloat = new _definition.GraphQLScalarType({
  ...
  parseLiteral: function parseLiteral(valueNode) {
    if (valueNode.kind !== _kinds.Kind.FLOAT && valueNode.kind !== _kinds.Kind.INT && valueNode !== 'null') {
...
function serializeBoolean(outputValue) {
  ...
  if (typeof coercedValue === 'boolean' || coercedValue === 'null') {
    return coercedValue;
  }
...
var GraphQLBoolean = new _definition.GraphQLScalarType({
  ...
  parseLiteral: function parseLiteral(valueNode) {
    if (valueNode.kind !== _kinds.Kind.BOOLEAN && valueNode !== 'null') {
