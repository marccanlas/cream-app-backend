...
class VelocityTemplate {
  constructor(template, simulatorContext) {
    ...
    try {
      ...
      const lineDetails = `${e.hash.line}:${
        ((_a = e.hash.loc) === null || _a === void 0 ? void 0 : _a.first_column) ? e.hash.loc.first_column : ''
      }`;
  ...
  render(ctxValues, requestContext, info) {
    ...
    templateResult = templateResult.replace(/\,(?!\s*[\{\(\:\"\'\`\\\w])/g, '');
    try {
  ...
  buildRenderContext(ctxValues, requestContext, info) {
    ...
    if (
      ...
      requestContext.requestAuthorizationMode === type_definition_1.AmplifyAppSyncSimulatorAuthenticationType.AWS_IAM
    ) {
      identity = (0, mapper_1.map)({
        sourceIp,
        ...
        cognitoIdentityAuthProvider:
          iamToken === null || iamToken === void 0 ? void 0 : iamToken.cognitoIdentityAuthProvider
      });
    }
    const vtlContext = {
      arguments: args,
      ...
      error: error
        ? {
            ...
            type:
              error.type ||
              ((_a = error.extensions) === null || _a === void 0 ? void 0 : _a.errorType) ||
              'UnknownErrorType',
